...
router.get("/report", ReportController.getTemplateCount);  
router.get("/report/:id", ReportController.getRequestCount); 
router.put("/report/:id", ReportController.updateTemplateCount);  
router.put("/report/:id", ReportController.updateRequestCount);  
